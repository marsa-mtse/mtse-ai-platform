...
APP_VERSION = "11.0.0" 
APP_NAME_AR = "منصة MTSE v11 - السيادة الرقمية"
APP_NAME_EN = "MTSE v11 - Digital Sovereignty"
...
<style>
    ...
    /* Main Theme - The v10 Singularity */
    :root {{
        --primary: {PRIMARY};
        ...
        --glass-border: {BORDER_GLOW};
        --quantum-glow: 0 0 20px { "rgba(139, 92, 246, 0.3)" if IS_DARK else "rgba(139, 92, 246, 0.1)" };
    }}
    ...
    .stApp {{
        ...
        background: {BG_MAIN};
        background-image: {
            "radial-gradient(circle at top right, #1e1b4b, #030712)" if IS_DARK else
            "radial-gradient(circle at top right, #e2e8f0, #f8fafc)"
        };
